...
const NameIcon = ({ name }) => {
    ...
    return (
        <div className="size-11 flex justify-center items-center rounded-full p-1.5 text-sm text-white border-2 border-white" style={{ backgroundColor: `hsl(${hue(values[0], values[1])}, 50%, 50%)` }}>
